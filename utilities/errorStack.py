...
def errorMessageSp(code):
        return {
         ...
         200: lambda: "Caracter no reconocido", #caracter no reconocido
         ...
         304: lambda: "Intento de comparacion de un identificador no declarado", 
         305: lambda: "Intento de comparacion entre una cadena y un numerico", 
         306: lambda: "Intento de comparacion entre un numerico y una cadena"
